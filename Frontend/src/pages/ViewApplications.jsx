            ...
            <table className='w-full max-w-4xl bg-white border border-gray-200 max-sm:text-sm'>
                <thead>
                    <tr className='border-b'>
                        ...
                        <th className='py-2 text-left max-sm:hidden'>Job Title</th>
                        <th className='py-2 text-left max-sm:hidden'>Location</th>
                        <th className='py-2 text-left'>Resume</th>
                    ...
                    {viewApplicationsPageData.map((applicant,index)=>(
                        <tr key={index} className='text-gray-700'>
                            ...
                            <td className='py-2 px-4 border-b'>
                                ...
                                href={applicant.resume} target="_blank">Resume
                            ...
                            <td className='py-2 px-4 border-b relative'>
                                <div className='relative inline-block text-left group'>
                                    ...
                                    <div className='z-10 hidden absolute right-0 left-0 top-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow group-hover:block'>
                                        <button className='block w-full text-left px-4 py-2 text-blue-500 hover:bg-gray-100'>Shortlist</button>
