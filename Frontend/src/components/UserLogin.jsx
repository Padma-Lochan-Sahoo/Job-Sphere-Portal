...
const UserLogin = () => {
  ...
  const { setShowUserLogin, loginUser, registerUser, setRole, userData } =
  ...
  return (
    <div className="absolute top-0 bottom-0 left-0 right-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center">
      <form
        ...
        className="relative bg-white p-10 rounded-xl text-slate-500 w-[90%] sm:w-[400px]"
      >
        ...
        <div className="border px-4 py-2 flex items-center gap-2 rounded-full mt-5">
          ...
          <input
            ...
            required
          />
          {isTyping && // Show the icon only when the user is typing or focused
            (showPassword ? (
              <Eye
